      ...
      <Container as={Stack} maxW={'6xl'} py={10}>
        <SimpleGrid
          ...
          <Stack spacing={6}>
            ...
            <Text fontSize={'sm'}>Copyright© 2025 Created by team KickzHub</Text>
          ...
          <Stack align={'flex-start'}>
            ...
            <ChakraLink href={'#'}>Về chúng tôi</ChakraLink>
            <ChakraLink href={'#'}>Blog</ChakraLink>
            <ChakraLink href={'#'}>Liên hệ</ChakraLink>
            <ChakraLink href={'#'}>Giá cả</ChakraLink>
            <ChakraLink href={'#'}>Lời chứng thực</ChakraLink>
          </Stack>
          <Stack align={'flex-start'}>
            <ListHeader>Hỗ trợ</ListHeader>
            <ChakraLink href={'#'}>Trung tâm trợ giúp</ChakraLink>
            <ChakraLink href={'#'}>Điều khoản dịch vụ</ChakraLink>
            <ChakraLink href={'#'}>Pháp lý</ChakraLink>
            <ChakraLink href={'#'}>Chính sách bảo mật</ChakraLink>
            <ChakraLink href={'#'}>Trạng thái</ChakraLink>
          </Stack>
          <Stack align={'flex-start'}>
            <ListHeader>Cập nhật thông tin</ListHeader>
            <Stack direction={'row'}>
              <Input
